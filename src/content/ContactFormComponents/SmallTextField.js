    ...
    render() {
        ...
        return <Fragment>
            <div className={styles.line}>
                ...
                <InputField disabled={this.props.disabled} type='text' onChange={this.props.onChange?this.props.onChange:this.change} value={this.props.value?this.props.value:this.state.value} name={this.props.name}
